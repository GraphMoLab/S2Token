...
class LLaMoStage(pl.LightningModule):
    ...
    def save_predictions(self, predictions, targets):
        ...
        with open(os.path.join(self.logger.log_dir, f"predictions_{self.current_epoch}.txt"), 'w', encoding='utf8') as f:
    ...
    def test_step(self, batch, batch_idx):
        ...
        prediction_ids = self.mllm.generate(
            ...
            substruct_indexer=batch['substruct_indexer'],
            substruct_nodes=batch['substruct_nodes'],
            coarsen_adj=batch['coarsen_adj'],
            structure_pes=batch['structure_pes'],
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if self.global_rank == 0:
            ...
            metrics_file = os.path.join(self.logger.log_dir, "metrics_log.txt")
